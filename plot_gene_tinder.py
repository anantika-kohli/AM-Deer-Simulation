...
#PHENO AT AM 0.5
df = pd.read_csv("IBD_P_kp_0.5/P0.5aggregated_results_primary.csv")
print(df.columns)
...
parents = df[["run_id", "generation", "id", "phenotype_score"]].copy()
parents["id"] = parents["id"].astype(int)
...
mate_pairs = mate_pairs.dropna(subset=["mom_pheno", "dad_pheno"])
# absolute phenotype difference per mating pair
mate_pairs["pheno_diff"] = (mate_pairs["mom_pheno"] - mate_pairs["dad_pheno"]).abs()

mate_pairs.to_csv("mate_pairs_P0.5_with_pheno.csv", index=False)




#PHENO AT AM 0.25
df = pd.read_csv("IBD_P_kp_0.25/P0.25aggregated_results_primary.csv")
print(df.columns)
...
# absolute phenotype difference per mating pair
mate_pairs["pheno_diff"] = (mate_pairs["mom_pheno"] - mate_pairs["dad_pheno"]).abs()
mate_pairs.to_csv("mate_pairs_P0.25_with_pheno.csv", index=False)


#PHENO AT AM 0
df = pd.read_csv("IBD_P_kp_0/P0aggregated_results_primary.csv")
print(df.columns)
...
# absolute phenotype difference per mating pair
mate_pairs["pheno_diff"] = (mate_pairs["mom_pheno"] - mate_pairs["dad_pheno"]).abs()
mate_pairs.to_csv("mate_pairs_P0_with_pheno.csv", index=False)


##PHENO AT AM 0.75
df = pd.read_csv("IBD_P_kp_0.75/P0.75aggregated_results_primary.csv")
print(df.columns)
...
# absolute phenotype difference per mating pair
mate_pairs["pheno_diff"] = (mate_pairs["mom_pheno"] - mate_pairs["dad_pheno"]).abs()
mate_pairs.to_csv("mate_pairs_P0.75_with_pheno.csv", index=False)



##PHENO AT AM 1
df = pd.read_csv("IBD_P_kp_1/P1aggregated_results_primary.csv")
print(df.columns)
...
# absolute phenotype difference per mating pair
mate_pairs["pheno_diff"] = (mate_pairs["mom_pheno"] - mate_pairs["dad_pheno"]).abs()
mate_pairs.to_csv("mate_pairs_P1_with_pheno.csv", index=False)
